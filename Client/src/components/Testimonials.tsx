      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="bg-gray-900/50 backdrop-blur-lg rounded-xl p-6 border border-white/10 relative group hover:scale-102 transition-transform duration-200"
            >
              <Quote className="absolute top-4 right-4 w-6 h-6 text-blue-500/20" />
              <div className="flex items-center space-x-4 mb-4">
                <div className="w-12 h-12 rounded-full bg-blue-500/20 border-2 border-blue-500/50" />
                <div>
