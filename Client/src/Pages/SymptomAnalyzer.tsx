...
//                   className="cursor-pointer flex items-center text-3xl font-bold bg-gradient-to-r from-blue-500 to-green-400 bg-clip-text text-transparent gap-3"
//                 >
      ...
      <nav className="p-4 sm:p-6">
        ...
        >
          <motion.div
            initial={{ opacity: 0, x: -20 }}
            animate={{ opacity: 1, x: 0 }}
            className="flex items-center text-2xl sm:text-3xl font-bold bg-gradient-to-r from-blue-500 to-green-400 bg-clip-text text-transparent gap-2 sm:gap-3 hover:scale-105 transition-transform duration-200"
          >
            <img 
              src="/icons.webp" 
              alt="Logo" 
            ...
            />
            <span className="cursor-pointer">medify.me</span>
          </motion.div>
        </div>
      </nav>
        ...
        >
          ...
          >
            <div className="flex items-center justify-center space-x-3 sm:space-x-4">
              ...
              <h1 className="text-2xl sm:text-4xl font-bold text-white">Symptom Analyzer</h1>
            </div>
          ...
          <div className="bg-black/20 backdrop-blur-sm rounded-xl p-4 sm:p-8 space-y-4 sm:space-y-6 border border-neutral-800 shadow-md">
            <form onSubmit={handleAnalyze} className="space-y-4 sm:space-y-6">
              <div className="space-y-2">
                <label htmlFor="symptoms" className="block text-base sm:text-lg font-medium text-gray-300">
                  What symptoms are you experiencing?
                </label>
                <div className="relative">
                  <textarea
            ...
            <AnimatePresence>
              ...
              {analysis && (
                ...
                >
                  <h2 className="text-lg sm:text-xl font-semibold text-blue-400 mb-3 sm:mb-4">Analysis</h2>
