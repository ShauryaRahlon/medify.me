      ...
      <div className="relative z-10">
        <div className="container mx-auto px-4">
          <nav className="sm:p-4 mb-2">
            ...
            >
              <div className="relative flex gap-4 py-1 z-10" onClick={handleUserSwitch}>
          ...
          <div className="max-w-2xl mx-auto">
            <header className="text-center mb-12">
              ...
              >
                ...
                <h1 className="text-3xl sm:text-4xl font-bold text-white">Nutrition Analyzer</h1>
              </motion.div>
            </header>
            ...
            >
              ...
              >
                ...
                <p className="text-neutral-400">
                  {file ? `Uploaded: ${file.name}` : "Drag & drop a food image (Optional)"}
                </p>
              </div>
              ...
              <AnimatePresence>
                ...
                {error && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0, y: -10 }}
                    className="mt-4 p-4 bg-red/10 border border-red/20 rounded-lg 
